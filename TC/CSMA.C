...
////////////////////////////////
   asm{
	...
	outportb(buffer_TX+3,0x83);
	outportb(buffer_TX,1);
	outportb(buffer_TX+1,0);
	outportb(buffer_TX+3,3);
	outportb(buffer_TX,0x00);
 ///////////////////////////////
